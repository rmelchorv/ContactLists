...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contacts.add(new ContactModel("Juan Penas","9710000001","juan.penas@gmail.com"));
        ...
        contacts.add(new ContactModel("Patt Games","9710000005","patt.games@gmail.com"));
        contacts.add(new ContactModel("Alan Horne","9710000006","alan.horne@gmail.com"));
        contacts.add(new ContactModel("Pepe Pecas","9710000007","pepe.pecas@gmail.com"));
        contacts.add(new ContactModel("Hugo Sante","9710000008","hugo.sante@gmail.com"));
        contacts.add(new ContactModel("Paco Picas","9710000009","paco.picas@gmail.com"));
        contacts.add(new ContactModel("Luis Aloro","9710000010","luis.aloro@gmail.com"));
